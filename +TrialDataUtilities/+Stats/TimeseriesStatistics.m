classdef TrialDataUtilities.Stats.TimeseriesStatistics
    ...
    methods(Static) % Effect size methods
        function [dprimeTensor, dprimeCI, tvec] = dPrimeAlongAxisVsTime(tdca, varargin)
            ...
            [misc, dprimeTensor, dprimeHigh, dprimeLow] = TrialDataUtilities.Stats.TimeseriesStatistics.evaluateComparisonAlongAxisVsTime(tdca, @dprimeFn, p.Unmatched);
            tvec = misc.tvec;
        ...
        function [gTensor, gCI, tvec] = hedgesGAlongAxisVsTime(tdca, varargin)
            ...
            import(getPackageImportString);
            [misc, gTensor, gHigh, gLow] = TrialDataUtilities.Stats.TimeseriesStatistics.evaluateComparisonAlongAxisVsTime(tdca, @hedgesGFn, p.Unmatched);
            tvec = misc.tvec;
